        ...
        render={data => (
          <>
            <Helmet
              ...
              meta={[
                { name: 'twitter:card', content: 'NYC Civic Jobs' },
                { name: 'twitter:url', content: 'https://civicjobs.nyc' },
                { name: 'twitter:description', content: 'NYC Civic Jobs, a simple site for browsing NYC Government Jobs' },
